...
onde $a, b, c$ são constantes não negativas especificadas e $C$ não depende de $x, y, z$. Explique como podemos simular o vetor$(X, Y, Z)$ e realize uma simulação para estimar $\mathbb{E}[X]$ e $\mathbb{E}[XYZ]$ quando $a = b = c = 1$.
...
matriz_simulacao <- matrix(NA, nrow = N_samples, ncol = 3)
tentativas <- 0
