...
O estimador é simples: $\hat\theta_{MC} = \frac{1}{K}\sum_{i=1}^K I(X_i > 1)$, onde $I(\cdot)$ é a função indicadora. Esse método é fácil, mas apresenta alta variância porque depende da dupla simulação de $Y$ e do erro $\varepsilon$.
